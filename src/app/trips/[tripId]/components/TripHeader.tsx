...
const TripHeader = ({ trip }: TripHeaderProps) => {
    return (
        <div className="flex flex-col">
            ...
            <div className="hidden px-5 pb-5 lg:grid grid-cols-[2fr,1fr,1fr] gap-2 grid-rows-2 lg:order-2">
            ...
            <div className="flex flex-col p-5 lg:order-1">
                ...
                <p className="text-sm text-grayPrimary lg:hidden">
                    <span className="text-primary font-semibold">R${trip.pricePerDay.toString()}</span> por noite
                </p>
            </div>
        </div>
    );
